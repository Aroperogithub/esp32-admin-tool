...
#define MQTTLED 2                  // GPIO13 LED INDICADOR MQTT
// -------------------------------------------------------------------
...
// -------------------------------------------------------------------
const size_t capacitywifi = JSON_OBJECT_SIZE(16)    + 424;  //El 16 es el número de objetos y el 424 es el tamaño del array.
const size_t capacitymqtt = JSON_OBJECT_SIZE(7)     + 196;
...
char    mqtt_server[70];            // Servidor del MQTT Broker
